...
def predict():
    ...
    dates_3 = data.get("duration3")
    dates_3 = dates_3.split(' ')
    dates_3 = dates_3[0]
    
    dates_1 = data.get("dates_1")
    dates_1 = dates_1.split(' ')
    dates_2 = data.get("dates_2")
    dates_2 = dates_2.split(' ')
    dates_3 = data.get('dates_3')
    dates_3 = dates_3.split(' ')
    Age = data.get('Age')
    Age = int(Age)
    Feet = data.get('Feet')
    ...
    third_cycle = datetime.strptime(dates_3[0], date_format) # most recent (1 month ago)
    second_cycle = datetime.strptime(dates_2[0], date_format) # second most recent (2 months ago)
    first_cycle = datetime.strptime(dates_1[0], date_format) # third most recent (3 months ago)
    
    # convert to cycle lengths
    user_cycle1 = (third_cycle - second_cycle) # second most recent cycle
    user_cycle2 = (second_cycle - first_cycle) # most recent cycle
