...
# determine the path of model.py
model_path = os.path.join(current_path, 'ml-model', 'model.py')
...
# import the BMICalculator class from model.py
# check if the model.py file is in the path
...
from model.py import BMICalculator
...
# X_train = pd.read_csv('https://github.com/kholl28/data/raw/refs/heads/main/X_train.csv')
# y_train = pd.read_csv('https://github.com/kholl28/data/raw/refs/heads/main/y_train.csv')
