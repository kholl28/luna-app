...
def predict():
    ...
    # Add these debug lines before creating user_input
print("X_train columns:", X_train.columns.tolist())
print("Input dict keys:", list(input_dict.keys()))

# Then modify how you create the user input DataFrame
...
for col in X_train.columns:
    if col not in user_input.columns:
        user_input[col] = np.nan  # Add missing columns

# Keep only the columns in X_train
