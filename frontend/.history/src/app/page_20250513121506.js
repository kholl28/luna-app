...
import Prediction from './pages/prediction old';
...
function App() {
    ...
    if (currentPage === 'homepage') {
        ...
        return <Input 
          currentPage={currentPage} 
          setCurrentPage={setCurrentPage}
          Age={Age}  // Make sure this matches the state variable name
          setAge={setAge}
          Feet={Feet}
          setFeet={setFeet}
          Inches={Inches}
          ...
          thirdDate={thirdDate}
          setThirdDate={setThirdDate}
          dateError={dateError}
          setDateError={setDateError}
          date2Error={date2Error}
          setDate2Error={setDate2Error}
          setResult={setResult}
        />;
