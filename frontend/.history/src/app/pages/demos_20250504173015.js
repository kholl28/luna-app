  ...
  <div style={{
    ...
    <div>
      ...
      <div>
        ...
        <div style={{ color: '#EF5350', marginTop: '0.5rem', textAlign: 'center'}}>
            {demoError && (
                <p className= `verdana-xs ${(Age < 14 || Age > 60) && (Feet < 4 || Feet > 7) && (Inches < 0 || Inches > 11) && (Weight < 60 || Weight > 400) ? '' : 'hidden-text'}`}>
                {demoError}
                </p>
            )}
        </div>
