...
function Demos({ currentPage, setCurrentPage, UserName}) {
  const [Age, setAgeString] = useState(''); // Initialize with empty string instead of null
  const [Feet, setFeetString] = useState(''); // Initialize with empty string instead of null
  const [Inches, setInchesString] = useState(''); // Initialize with empty string instead of null
  const [Weight, setWeightString] = useState(''); // Initialize with empty string instead of null                
