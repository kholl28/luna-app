...
function Demos({ currentPage, setCurrentPage, UserName, setAge, setFeet, setInches, setWeight }) {
  ...
  return (
    <div style={{
      ...
      <div className={`verdana-s padding-class-aroundest fade-text ${visible ? 'visible' : ''}`}>
          First, let's start with some information about you. This will be used to make a more accurate prediction help us make a more accurate prediction.
      </div>
