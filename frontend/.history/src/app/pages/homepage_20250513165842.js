...
function Homepage({ currentPage, setCurrentPage, UserName, setName }) {
  ...
  <div style={{
    ...
    <div className={`fade-text ${visible ? 'visible' : ''}`}>
      ...
      This tool can present analysis' primary goal is to create a menstrual cycle tracker that can be used to predict the day a user's next period will start based on their demographic information and the lengths of their last two menstrual cycles.
      </p>
