...
function Homepage({ currentPage, setCurrentPage, UserName, setName }) {
  ...
  <div style={{
    ...
    <div className={`fade-text ${visible ? 'visible' : ''}`}>
      ...
      This tool can give you an accurate well-informed predict the day your next period will start based on their demographic information and the lengths of their last two menstrual cycles.
      </p>
