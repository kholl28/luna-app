...
function Homepage({ currentPage, setCurrentPage, UserName, setName }) {
  ...
  <div style={{
    ...
    <div className={`fade-text ${visible ? 'visible' : ''}`}>
      ...
      This tool can give you an accurate well-informed prediction of the day your next period will start based on you demographic information and the lengths of their last two menstrual cycles.
      </p>
