...
function Homepage({ currentPage, setCurrentPage, UserName, setName }) {
  ...
  <div style={{
    ...
    <div className={`fade-text ${visible ? 'visible' : ''}`}>
      ...
      <p className={`verdana-xs-italic padding-class-aroundish`}>
        A menstrual period predictor tool
      </p>
      <p className={`verdana-s-normal padding-class-aroundest`}>
      This tool will give you an accurate well-informed prediction of the day your next period will start based on some information about you.
      </p>
      <div className={`verdana-small padding-class-top fade-text2 ${visible ? 'visible' : ''}`}>
