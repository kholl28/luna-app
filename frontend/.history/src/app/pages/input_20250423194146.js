            ...
            {!showSecondCalendar && !showThirdCalendar && (
              <div style={{
                ...
                <div style={{
                  ...
                  {date.length > 0 && (
                    <p className={`verdana-small padding-class-around fade-text ${
                  ...
                  {secondDate.length > 0 && (
                  <p className={`verdana-small padding-class-around fade-text ${secondDate.length > 0 ? '' : 'hidden-date'}`}>
                  <b>Second period:</b>
                  <br />
                  <span className="bold">Start date:</span>
                ...
                {thirdDate.length > 0 && (
                  <p className={`verdana-small padding-class-around fade-text ${thirdDate.length > 2 ? '' : 'hidden-date'}`}>
