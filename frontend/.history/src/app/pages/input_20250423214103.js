...
function Input({ currentPage, setCurrentPage, UserName, setName, setAge, Age, Feet, setFeet, Inches, setInches, Weight, setWeight, 
            ...
            {!showSecondCalendar && !showThirdCalendar && (
              <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'center', marginTop: '2rem' }}>
                  {date.length > 2 && <Button onClick={handleSubmit}>Next</Button>}
                </div>
              </div>
            )}
            ...
            {showSecondCalendar && !showThirdCalendar && (
              <>
                ...
                {dateError && (
                  ...
                  <div style={{ display: 'flex', justifyContent: 'center', marginTop: '2rem' }}>
                    {secondDate.length > 2 && <Button onClick={handleSubmit2}>Next</Button>}
                  </div>
                </div>
              </>
            )}
              ...
              <>
                ...
                <p className={`verdana-small padding-class-around" ${thirdDate.length > 2 ? '' : 'hidden-date'}`}>
                 ...
                 {date2Error && (
                  ...
                  <div style={{ display: 'flex', justifyContent: 'center', marginTop: '2rem' }}>
                    {thirdDate.length > 2 && <Button onClick={handleClick}>Predict</Button>}
                  </div>
                </div>
              </>
            )}
