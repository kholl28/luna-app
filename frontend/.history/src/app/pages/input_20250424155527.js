...
function Input({ currentPage, setCurrentPage, setAge, Age, Feet, setFeet, Inches, setInches, Weight, setWeight, 
  ...
  const handleClick = () => {
    ...
    setLoading(true);
    const duration1 = formatDistance(date[0], date[1], { addSuffix: true });
    const duration2 = formatDistance(secondDate[0], secondDate[1], { addSuffix: true });
    const duration3 = formatDistance(thirdDate[0], thirdDate[1], { addSuffix: true });
