...
//   cycle_1 = dates_1[0] - dates_2[0]
// cycle_2 = dates_2[0] - dates_3[0]

cycle_1 = formatDistance(date[0], secondDate[0], { addSuffix: false });
cycle_2 = formatDistance(secondDate[0], thirdDate[0], { addSuffix: false });
  ...
  const handleClick = () => {
    ...
    setLoading(true);
    const duration1 = formatDistance(date[0], date[1], { addSuffix: false });
    const duration2 = formatDistance(secondDate[0], secondDate[1], { addSuffix: false });
    const duration3 = formatDistance(thirdDate[0], thirdDate[1], { addSuffix: false });
