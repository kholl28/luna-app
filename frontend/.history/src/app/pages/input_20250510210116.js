  ...
  const handleClick = async () => {
    ...
    try {
      ...
      const requestBody = {
        ...
        cycle_1: cycle1Days,
        cycle_2: cycle2Days,
        Age: parseInt(Age),          // Remove fallback to 0
        Feet: parseInt(Feet),        // Remove fallback to 0
        Inches: parseInt(Inches),    // Remove fallback to 0
        weight: parseFloat(Weight),  // Remove fallback to 0
      };
