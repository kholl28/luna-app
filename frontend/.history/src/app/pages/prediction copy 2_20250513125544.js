          ...
          <div style={{
            ...
            <div className={`fade-text ${visible ? 'visible' : ''}`}>
              <p className="verdana-small padding-class"> 
                ...
                the next. Overall, though, patterns exist among individual people in the lengths of each of their cycles.
                <br /><br />
                ...
                <br /><br />
                This is because a <b>menstrual cycle</b> is defined as the time <b>from the first day of a person's period to the day before the start date of the next period.</b>
                <br /><br />
