    ...
    return (
        <div>
          ...
          {predictionData ? (
            ...
            <p> This period predictor app was trained using data from a 2013 study by <a href="https://epublications.marquette.edu/cgi/viewcontent.cgi?article=1002&context=data_nfp">Fehring et al.</a>
            that collected data on the menstrual cycles of used a sample of 197 anonymous American women to compare the efficacy of two internet supported natural family planning methods </p>
          )}
        </div>
      </div>
    );
