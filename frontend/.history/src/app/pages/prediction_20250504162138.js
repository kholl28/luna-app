    ...
    return (
        <div>
          ...
          {predictionData ? (
            ...
            that collected data on the menstrual cycles from a sample of 197 anonymous American women to compare the efficacy of two internet supported natural family planning methods </p>
          )}
        </div>
      </div>
    );
