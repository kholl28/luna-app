    ...
    return (
        <div>
          ...
          {predictionData ? (
            ...
            that collected data on the menstrual cycles from a sample of 159 anonymous American women to compare the efficacy of two interneytsupported natural family planning methods </p>
          )}
        </div>
      </div>
    );
