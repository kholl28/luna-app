    ...
    return (
        <div>
          ...
          <div className={`fade-text ${visible ? 'visible' : ''}`}>
            ...
            that collected data on the menstrual cycles from a sample of 159 anonymous American women over a span of 12 months to compare the efficacy of two internet-supported natural family planning methods.\n
