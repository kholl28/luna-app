    ...
    return (
        <div>
          ...
          <div className={`fade-text ${visible ? 'visible' : ''}`}>
            ...
            For each woman, approximately 10 cycles were logged. For each cycle, information such as the length of the cycle, the overall mean cycle length for each clinet, length of menstruation
