    ...
    return (
        <div>
          ...
          <div className={`fade-text ${visible ? 'visible' : ''}`}>
            ...
            Specifically, women in different age groups and BMI categories experience significant differences in cycle length. Thus, the model will adjust its final prediction based on this User-inputted information.
