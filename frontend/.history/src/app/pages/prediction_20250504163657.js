    ...
    return (
        <div>
          ...
          <div className={`fade-text ${visible ? 'visible' : ''}`}>
            ...
            The average menstrual cycle length is around 28 days, but this varies from person to person. It's very common to have cycles that vary by up to five days from one month to the next. Overall, though,
            the length of past cycles can be used to predict the length of the future cycles. From this cycle length, the start date of the next period can be calculated.\n

            This is because a **menstrual cycle** is defined as **the time from the first day of a person's period to the day before the 
