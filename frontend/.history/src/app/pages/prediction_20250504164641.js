    ...
    return (
        <div>
          ...
          <div className={`fade-text ${visible ? 'visible' : ''}`}>
            ...
            Additionally,  For example, previous research has indicated that age and BMI (which is calculated from height and weight) have a significant relationship with the lenght of one's menstrual cycle.
