    ...
    return (
        <div>
          ...
          <div className={`fade-text ${visible ? 'visible' : ''}`}>
            ...
            Specifically, women in different age groups and BMI categories experience significant differences in cycle length. Specifically, until women are 50 years
