    ...
    return (
        <div>
          ...
          <div className={`fade-text ${visible ? 'visible' : ''}`}>
            ...
            Until women are 50 years or older, the lengths of their cycles tend to shorten on average. People under 20 years old had cycles 30.3 days long on average; 1.6 days longer than the 28.7-day
