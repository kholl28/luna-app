    ...
    return (
        <div>
          ...
          <div className={`fade-text ${visible ? 'visible' : ''}`}>
            ...
            As people age, the lengths of their cycles tend to shorten on average, until they reach 50 years or older, wherein their cycles become longer, and are typically the longest are the longest.
