    ...
    return (
        <div>
          ...
          <div className={`fade-text ${visible ? 'visible' : ''}`}>
            ...
            Without explicitly being told this, the model is able to identify these relationships. Then, when a user (that's you!) provides the model with new, unseen info
