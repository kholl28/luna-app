    ...
    return (
        <div>
          ...
          <div className={`fade-text ${visible ? 'visible' : ''}`}>
            ...
            This period predictor app was trained using data from a 2013 study by <a href="https://epublications.marquette.edu/cgi/viewcontent.cgi?article=1002&context=data_nfp">Fehring et al
            ...
            as well as the demographic information of the client (age, height, weight).<br />

            A computer model, known as a "machine learning model" was then fed this data and identified patterns between these variables.<br />
            ...
            the next. Overall, though, among individual people, patterns exist in the lengths of each of their cycles.<br />
            ...
            Specifically, women in different age groups and BMI categories experience significant differences in cycle length.<br />
