    ...
    return (
        <div>
          ...
          <div className={`fade-text ${visible ? 'visible' : ''}`}>
            ...
            This is because a <b>menstrual cycle is defined as the time from the first day of a person's period to the day before the start date of the next period.<br /><br />
