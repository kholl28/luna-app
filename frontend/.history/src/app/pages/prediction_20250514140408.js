    ...
    return (
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col items-center mb-10 text-center">
              ...
              <div className={`verdana-xs fade-text2 ${visible ? 'visible' : ''}`}>
                <p>
                  There is no exact science for calculating when your next period will start, and cycle length naturally fluctuates month to month for each person. 
                  So, this start date is just a well-informed estimate. 
                </p>
              </div>
          </div>
          ...
          <div className="max-w-xl mx-auto">
            ...
            <div className={`fade-text ${visible ? 'visible' : ''}`}>
              <p className="verdana-small padding-class-top-less"> 
                This period predictor app was trained using data from a 2013 study by <a href="https://epublications.marquette.edu/cgi/viewcontent.cgi?article=1002&context=data_nfp" className="text-blue-600 hover:underline">Fehring et al.</a>
                ...
                and then the day <em>after</em> those 28 days will be the date of your next period!
              </p>
            </div>
