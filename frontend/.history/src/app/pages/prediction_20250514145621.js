          ...
          <div className="w-full max-w-xl md:max-w-2xl lg:max-w-4xl mx-auto">
            ...
            <div className={`fade-text ${visible ? 'visible' : ''}`}>
              <p className="verdana-s-normal padding-class-top-less"> 
                ...
                Indeed, overall patterns exist among individual people in the lengths of each of their cycles.For instance, the average menstrual cycle length for all women in the world is around 28 days, but this varies from person to person. It's very common for people to have cycles that vary by up to five days from one month to 
                the next.<br /><br />
