          ...
          <div className="w-full max-w-xl md:max-w-2xl lg:max-w-4xl mx-auto">
            ...
            <div className={`fade-text ${visible ? 'visible' : ''}`}>
              <p className="verdana-s-normal padding-class-top-less"> 
                ...
                person to person. It's very common for people to have cycles that vary by up to five days from one month to the next.  people in the lengths of each of their cycles.<br /><br />
