          ...
          <div className="w-full max-w-xl md:max-w-2xl lg:max-w-4xl mx-auto">
            ...
            <div className={`fade-text ${visible ? 'visible' : ''}`}>
              <p className="verdana-s-normal padding-class-top-less"> 
                ...
                person to person. Some people have shorter cycles on average, whereas others have longer ones. Once you know your average cycle length, you can use this information<br /><br />
