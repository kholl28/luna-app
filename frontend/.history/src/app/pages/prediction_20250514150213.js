          ...
          <div className="w-full max-w-xl md:max-w-2xl lg:max-w-4xl mx-auto">
            ...
            <div className={`fade-text ${visible ? 'visible' : ''}`}>
              <p className="verdana-s-normal padding-class-top-less"> 
                ...
                Additionally, patterns exist among age and BMI (which is calculated from height and weight) previous research has indicated that age and BMI (which is calculated from height and weight) have a significant relationship with the length of one's menstrual cycles.
