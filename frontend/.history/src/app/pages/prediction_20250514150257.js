          ...
          <div className="w-full max-w-xl md:max-w-2xl lg:max-w-4xl mx-auto">
            ...
            <div className={`fade-text ${visible ? 'visible' : ''}`}>
              <p className="verdana-s-normal padding-class-top-less"> 
                ...
                Additionally, patterns exist among age and BMI (which is calculated from height and weight) and the average length of a person's menstrual cycle. Previous research has indicated that people in different age groups and BMI categories experience significant differences in cycle length.<br /><br />
