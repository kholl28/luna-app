          ...
          <div className="w-full max-w-xl md:max-w-2xl lg:max-w-4xl mx-auto">
            ...
            <div className={`fade-text ${visible ? 'visible' : ''}`}>
              <p className="verdana-s-normal padding-class-top-less"> 
                ...
                A computer model, known as a "machine learning model" was then fed this data and identified patterns between these variables. The model was able to look at each of the 159 women in the dataset 
                and identify a pattern in the lengths of their cycles.<br /><br />
