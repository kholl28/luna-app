          ...
          <div className="w-full max-w-xl md:max-w-2xl lg:max-w-4xl mx-auto">
            ...
            <div className={`fade-text ${visible ? 'visible' : ''}`}>
              <p className="verdana-s-normal padding-class-top-less"> 
                ...
                A computer model, known as a "machine learning model" was then fed this data and identified patterns between these variables. It looked at each of the 159 women in the dataset 
                and identified patterns in the lengths of their cycles and their deomographic information.<br /><br />
