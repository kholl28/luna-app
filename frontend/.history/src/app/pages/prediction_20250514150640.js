          ...
          <div className="w-full max-w-xl md:max-w-2xl lg:max-w-4xl mx-auto">
            ...
            <div className={`fade-text ${visible ? 'visible' : ''}`}>
              <p className="verdana-s-normal padding-class-top-less"> 
                ...
                This is because a <strong>menstrual cycle</strong> is defined as <strong>the time from the first day of a person's period to the day before the start date of the next period</strong>.<br /><br />
                
                For example, if the model predicts that, based on your past three periods and your age and BMI, that your next cycle will be 28 days long, it can take the date of your most recent period, add 28 days to it,
