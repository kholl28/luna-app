          ...
          <div className="flex flex-col items-center mb-10 text-center">
              ...
              <div className={`verdana-s-normal fade-text2 ${visible ? 'visible' : ''}`}>
                <p>
                  ...
                  In fact, it is very common for people to have cycles that vary by up to five days from one month to the next. So, this start date is just a well-informed estimate. The graph below shows you the range of dates your period could start in.
                </p>
              </div>
          </div>
