          ...
          <div className="flex flex-col items-center mb-10 text-center">
              ...
              <div className={`verdana-s-normal fade-text2 ${visible ? 'visible' : ''}`}>
                <p>
                  ...
                  In fact, it is common for people to have cycles that vary by up to five days from one month to the next. <br /> 
                  So, this start date is just a well-informed estimate. The graph below shows you the range of dates your period could start on.
                </p>
              </div>
          </div>
          ...
          <div className="w-full max-w-xl md:max-w-2xl lg:max-w-4xl mx-auto">
            ...
            <div className={`fade-text ${visible ? 'visible' : ''}`}>
              <p className="verdana-s-normal padding-class-top-less"> 
                ...
                A computer model, known as a "machine learning model" was then fed this data, looked at each of the 159 women in the dataset, and identified patterns between these variables.<br /><br />
                ...
                and BMI categories experience significant differences in cycle length. As people age, the lengths of their cycles tend to shorten on average, until they reach 50 years or older, wherein their cycles become longer, 
                and are typically the longest of all. For BMI, a 2022 analysis found that people with higher BMIs tend to have longer menstrual cycles.<br /><br />
                ...
                Since, as mentioned before, there is no exact science for calculating when your next period will start, this prediction is just a well-informed estimate. We are able to obtain a <em>range</em> of start dates for your next period by running the data
                you provded through the model multiple times, and then using the 95% confidence interval to determine the range of dates your next period could start on.
