          ...
          <div className="w-full max-w-xl md:max-w-2xl lg:max-w-4xl mx-auto">
            ...
            <div className={`fade-text ${visible ? 'visible' : ''}`}>
              <p className="verdana-s-normal padding-class-top-less"> 
                ...
                Since, as mentioned before, there is no exact science for calculating when your next period will start, we can get a range of d running the data you provided through the model multiple times, we can also obtain a range of dates your next period could start on.
