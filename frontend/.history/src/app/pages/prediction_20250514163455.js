...
const Prediction = ({ setCurrentPage, currentPage, result, setResult, setName, UserName }) => {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
          ...
          {/* <div className="w-full max-w-lg md:max-w-xl lg:max-w-3xl mx-auto h-auto max-h-[10vh]"> */}
          <div className="max-w-xl lg:max-w-3xl mx-auto h-auto max-h-[10vh]">
            {predictionData ? (
            ...
            <div className={`fade-text ${visible ? 'visible' : ''}`}>
              <p className="verdana-s-normal padding-class-top-less"> 
                ...
                Since, as mentioned before, there is no exact science for calculating when your next period will start, we can also obtain a range of dates your next period could start on by running the data you provided through the model multiple times.<br /><br />

                With this range of dates, this tool can help you feel a little less anxious about your next period and help you plan ahead!
